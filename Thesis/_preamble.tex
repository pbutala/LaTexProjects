...
\newcommand{\cvtitle}[1]{{\LARGE {\textbf{#1}}}}
\newcommand{\cvname}[1]{{\Large {\textbf{#1}}}}
\newcommand{\cvheadi}[1]{{\large{\uppercase{\textbf{#1}}}}}
\newcommand{\cvheadii}[1]{{\textbf{#1}}}
\newcommand{\cvheadiii}[1]{{\textit{#1}}}
\newcommand{\cvdate}[1]{{#1}}
%\allowdisplaybreaks
%==========================================================================%