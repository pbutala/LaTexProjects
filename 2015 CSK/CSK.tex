...
\begin{floatrow}
		\capbtabbox{
			...
			\end{tabular}}
			{\caption{Color bands.}}
			\ffigbox{\includegraphics[trim={4.3in 0in 4.3in 0.5in}, clip=true, width=1.9in]{CBCcenters.eps}}
...
\begin{figure}[b]
	\centering
		...
		\centering
			...
			\label{fig16RcvSymY0}
		\end{subfigure}
	\caption{Received symbols for CBC$_{2}$. (\subref{fig4RcvSym}),(\subref{fig8RcvSym}),(\subref{fig16RcvSym}): Receiver output not clipped. (\subref{fig4RcvSymY0}),(\subref{fig8RcvSymY0}),(\subref{fig16RcvSymY0}): Negative values of receiver output clipped at 0.}
	\label{figRcvSym}
\end{figure}
...
Note that in \figurename\ref{figRcvSym} (\subref{fig4RcvSym}),
...
(\subref{fig8RcvSymY0}) and (\subref{fig16RcvSymY0}). However, this
