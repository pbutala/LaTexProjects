...
\bibitem{rah15a} Rahaim et al ''{Towards Practical Integration of Dual-Use VLC within 5G Networks},'' to appear in IEEE Wireless Comm. (2015).
\bibitem{gru08b} Grubor et al ''{Broadband Information Broadcasting Using LED-Based Interior Lighting},'' J. Lightwave Tech. {\bf 26}(24), 3883--3892 (2008).
\bibitem{min08a} Minh et al ''{High-Speed Visible Light Communications Using Multiple-Resonant Equalization},'' IEEE Photon. Lett. {\bf 20}(14), 1243--1245 (2008).
\bibitem{arm09a} J. Armstrong ''{OFDM for Optical Communications},'' J. Lightwave Tech. {\bf 27}(3), 189-204 (2009).
\bibitem{but14b} Butala et al ''{Sample indexed spatial orthogonal frequency division multiplexing},'' Chin. Opt. Lett. {\bf 12}(9), 090602 (2014)
\bibitem{cskxy} Yokoi et al, ''{CSK constellation in all color band combinations},'' {https://mentor.ieee.org/802.15/dcn/11/15-11-0247-00-0007-csk-constellation-in-all-color-band-combinations.pdf} (2011).
\bibitem{but12a} Butala et al ''{Metameric modulation for diffuse visible light communications with constant ambient lighting},'' Intl. Workshop on Opt. Wireless Comm. (IWOW), 1-3 (2012).
...
\bibitem{raj12a} Rajagopal et al ''{IEEE 802.15.7 visible light communication: modulation schemes and dimming support},'' IEEE Comm. Mag. {\bf 50}(3), 72-82 (2012).
\bibitem{sin13a} Singh et al ''{Performance evaluation of IEEE 802.15.7 CSK physical layer},'' Globecom Workshops, IEEE 1064-1069 (2013).
...
\begin{floatrow}
		\capbtabbox{
			...
			\end{tabular}}
			{\caption{Color bands.}}
			\ffigbox{\includegraphics[trim={4.3in 0in 4.3in 0.5in}, clip=true, width=1.8in]{CBCcenters.eps}}
...
\begin{figure}[b]
	\centering
		\begin{subfigure}{0.32\textwidth}
		\centering
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.3in}, clip=true, width=\textwidth]{M04_4-CSK_CBC1_ReceivedSymbols3.eps}
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M04_4-CSK_CBC2_ReceivedSymbols3.eps}
			\caption{4-CSK}
			\label{fig4RcvSym}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
		\centering
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.3in}, clip=true, width=\textwidth]{M08_8-CSK_CBC1_ReceivedSymbols4.eps}
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M08_8-CSK_CBC2_ReceivedSymbols4.eps}
			\caption{8-CSK}
			\label{fig8RcvSym}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
		\centering
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.3in}, clip=true, width=\textwidth]{M16_16-CSK_CBC1_ReceivedSymbols3.eps}
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M16_16-CSK_CBC2_ReceivedSymbols4.eps}
			\caption{16-CSK}
			\label{fig16RcvSym}
		\end{subfigure}
...
\begin{figure}[b]
	\centering
		\begin{subfigure}{0.32\textwidth}
		\centering
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.3in}, clip=true, width=\textwidth]{M04_4-CSK_CBC1_ReceivedSymbols9_NL.eps}
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M04_4-CSK_CBC1_ReceivedSymbols9_NL.eps}
			\caption{CBC$_{1}$: 4-CSK}
			\label{fig4RcvSym_NL}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
		\centering
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.3in}, clip=true, width=\textwidth]{M08_8-CSK_CBC1_ReceivedSymbols11_NL.eps}
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M08_8-CSK_CBC1_ReceivedSymbols9_NL.eps}
			\caption{CBC$_{1}$: 8-CSK}
			\label{fig8RcvSym_NL}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
		\centering
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.3in}, clip=true, width=\textwidth]{M16_16-CSK_CBC1_ReceivedSymbols11_NL.eps}
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M16_16-CSK_CBC1_ReceivedSymbols10_NL.eps}
		...
		\begin{subfigure}{0.32\textwidth}
		\centering
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M04_4-CSK_CBC8_ReceivedSymbols3_NL.eps}
			\caption{CBC$_{8}$: 4-CSK}
			\label{fig4RcvSym_NL8}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
		\centering
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M08_8-CSK_CBC8_ReceivedSymbols3_NL.eps}
			\caption{CBC$_{8}$: 8-CSK}
			\label{fig8RcvSym_NL8}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
		\centering
			\includegraphics[trim={4.7in 0.3in 4.5in 0.3in}, clip=true, width=\textwidth]{M16_16-CSK_CBC8_ReceivedSymbols3_NL.eps}
...
\begin{figure}[t]
	\centering
		...
		\centering
			...
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.33in}, clip=false, width=\textwidth]{M04_4-CSK_BERvsLSNR_NL.eps}
			\caption{4-CSK}
			\label{fig4LSNR}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
		\centering
			...
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.33in}, clip=false, width=\textwidth]{M08_8-CSK_BERvsLSNR_NL.eps}
			\caption{8-CSK}
			\label{fig8LSNR}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
		\centering
			...
			%\includegraphics[trim={0.0in 0.0in 0.1in 0.33in}, clip=false, width=\textwidth]{M16_16-CSK_BERvsLSNR_NL.eps}
			\caption{16-CSK}
			\label{fig16LSNR}
		\end{subfigure}
